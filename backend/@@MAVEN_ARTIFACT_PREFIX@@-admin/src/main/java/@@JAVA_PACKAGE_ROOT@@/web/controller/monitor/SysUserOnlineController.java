package @@JAVA_PACKAGE_ROOT@@.web.controller.monitor;
...
import @@JAVA_PACKAGE_ROOT@@.system.domain.SysUserOnline;
import @@JAVA_PACKAGE_ROOT@@.system.service.ISysUserOnlineService;
