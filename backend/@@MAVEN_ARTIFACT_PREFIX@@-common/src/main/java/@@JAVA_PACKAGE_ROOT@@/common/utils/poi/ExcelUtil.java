package @@JAVA_PACKAGE_ROOT@@.common.utils.poi;
...
import @@JAVA_PACKAGE_ROOT@@.common.annotation.Excel.ColumnType;
import @@JAVA_PACKAGE_ROOT@@.common.annotation.Excel.Type;
import @@JAVA_PACKAGE_ROOT@@.common.annotation.Excels;
...
import @@JAVA_PACKAGE_ROOT@@.common.exception.UtilException;
import @@JAVA_PACKAGE_ROOT@@.common.utils.DateUtils;
import @@JAVA_PACKAGE_ROOT@@.common.utils.DictUtils;
import @@JAVA_PACKAGE_ROOT@@.common.utils.StringUtils;
import @@JAVA_PACKAGE_ROOT@@.common.utils.file.FileTypeUtils;
import @@JAVA_PACKAGE_ROOT@@.common.utils.file.FileUtils;
import @@JAVA_PACKAGE_ROOT@@.common.utils.file.ImageUtils;
import @@JAVA_PACKAGE_ROOT@@.common.utils.reflect.ReflectUtils;
...
public class ExcelUtil<T>
{
    ...
    {
        String downloadPath = @@CONFIG_CLASS@@.getDownloadPath() + filename;
