...
import @@JAVA_PACKAGE_ROOT@@.system.domain.SysNotice;
import @@JAVA_PACKAGE_ROOT@@.system.domain.SysNoticeRead;
import @@JAVA_PACKAGE_ROOT@@.system.mapper.SysNoticeReadMapper;
import @@JAVA_PACKAGE_ROOT@@.system.service.ISysNoticeReadService;
